...
main (int argc, char *argv[])
{
  ...
  Ptr<SpectrumChannel> chan = channel.Create();
  ...
  for (NetDeviceContainer::Iterator it = staDevices.Begin(); it != staDevices.End(); ++it){
    ...
    Ptr<SpectrumWifiPhy> wifiphy = StaticCast<SpectrumWifiPhy>(wifiNetDev ->GetPhy());
    // wifiphy->SetAntenna(CreateObject<CosineAntennaModel>());
  }
